from .nodes.cascades import NODE_CLASS_MAPPINGS as CASCADE_NODE_CLASS_MAPPINGS
from .nodes.cascades import NODE_DISPLAY_NAME_MAPPINGS as CASCADE_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(CASCADE_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(CASCADE_NODE_DISPLAY_NAME_MAPPINGS)
